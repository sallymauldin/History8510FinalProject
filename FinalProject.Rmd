...
ggplot(charlestonManumissions.afterAmRev.year, aes(x = year, y = count)) +
  ...
  labs(x="Year", y="Count")
```
	Interestingly, manumissions increased toward the end of the 18th century, reaching high points in 1796 and 1800. The question is why manumissions were granted at higher numbers during the final years of the century. The answer most likely lies in changes to South Carolina manumission laws that took effect around 1800 that “all but eliminated enslaved people’s possibilities of moving from enslavement to freedom.”^[fn8]  It is possible that some benevolent owners granted freedom before the law changed to make manumission more difficult. It is also possible that the enslaved negotiated even more fervently than before for their freedom, knowing that the window of possibility was about to close to them forever. Indeed, it is during this time period that South Carolina “slowly shifted from an environment in which manumission was tolerated under carefully controlled conditions” to “one in which manumission represented too great a threat to the institution of slavery to allow at all.”^[fn9]  The dataset represents a flash point in South Carolina history with respect to freed people and a turning point in ideology and economy that can be seen in the sharp drop in manumissions from 1800 to 1801.
```{r}
...
```
  ...
  In short, this small dataset does not point to any clear evidence that notions of freedom brought on by revolutionary sentiment resulted in an increase in manumissions. Rather, it appears as though the enslaved found ways to buy their own freedom by recognizing that South Carolina law was about to change to make manumission nearly impossible. This dataset does appear to be in keeping with the theory that “far more people professed antislavery sentiment than acted on that sentiment,” and draws a “distinction between belief and action – between individuals passively lamenting slavery and group initiatives against slavery.”^[fn11] While the historiography has traditionally been about “stark choices” between the sentimental and the practical, there are “more nuanced” ways to view manumission during the American Revolution, and datasets like this one assist in seeking the truth behind manumission motives.^[fn12] In Charleston, there was no significant link found between revolutionary ideals and numbers of manumissions. Increased manumissions appeared to be more closely linked to changes in South Carolina law instead.
  

[^fn1]: Blanck, Emily. “The Legal Emancipations of Leander and Caesar: Manumission and the Law in Revolutionary South Carolina and Massachusetts.” Slavery & Abolition 28, no. 2 (2007): 235–54. 238. https://doi.org/10.1080/01440390701428030.

[^fn2]: Ibid, 240.

[^fn3]: Ibid, 244.

[^fn4]: Myers, Amrita Chakrabarti. 2011. Forging Freedom: Black Women and the Pursuit of Liberty in Antebellum Charleston. Chapel Hill: University of North Carolina Press. Accessed April 15, 2023. ProQuest Ebook Central. 41.

[^fn5]: Milteer, Warren Eugene. Beyond Slavery’s Shadow: Free People of Color in the South. Chapel Hill: University of North Carolina Press, 2021. 38.

[^fn6]: Ibid, 55.

[^fn7]: Marks, John, "Manumissions Database, Charleston District, South Carolina (1776-1800)," 12/31/13 - 12/31/13. 34. Philadelphia, PA: McNeil Center for Early American Studies [distributor], 2018. https://repository.upenn.edu. Note that the actual years contained in the dataset differ from the information given by the creator in the dataset’s description as well as the preferred citation.

[^fn8]: Marks, John Garrison. “Race and Freedom in the African Americas: Free People of Color and Social Mobility in Cartagena and Charleston.” ProQuest Dissertations Publishing, 2016. 20.

[^fn9]: Ibid, 21-22.

[^fn10]: Blanck, 244.

[^fn11]: Hammond, John Craig, and Matthew. Mason. Contesting Slavery the Politics of Bondage and Freedom in the New American Nation. Charlottesville: University of Virginia Press, 2011. 12.
